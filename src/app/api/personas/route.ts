  ...
  try {
    ...
    const persona = await prisma.persona.create({
      data: {
        ...
        framePrompt: framePrompt || null,
        masterVideoPrompt: masterVideoPrompt || null,
        weeklyReelsTarget: weeklyReelsTarget ? parseInt(weeklyReelsTarget, 10) : 3,
        weeklyFeedTarget: weeklyFeedTarget ? parseInt(weeklyFeedTarget, 10) : 4,
        dailyStoriesTarget: dailyStoriesTarget ? parseInt(dailyStoriesTarget, 10) : 5,
